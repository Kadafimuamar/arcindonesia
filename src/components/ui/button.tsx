...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 rounded-full text-sm font-semibold transition-colors disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        primary: "bg-primary px-5 py-3 text-primary-foreground hover:bg-primary/90",
        accent: "bg-accent px-5 py-3 text-accent-foreground hover:bg-accent/90",
        outline: "border border-border bg-card px-5 py-3 text-foreground hover:bg-secondary",
